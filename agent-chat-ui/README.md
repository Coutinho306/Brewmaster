...
> **Note:** This is a modified copy of the open-source [Agent Chat UI](https://github.com/langchain-ai/agent-chat-ui) by LangChain.
> Some changes have been made to fit the Brewmaster project. If you want to refer to the original, follow the link above.

Brewmaster Chat UI is a Next.js application which enables chatting with the Brewmaster LangGraph agent through a chat interface.
